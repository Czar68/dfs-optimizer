# Final PP vs UD trueProb comparison
...
if ($matchingKeys.Count -eq 0) {
    ...
    Write-Host "No overlapping props found between PP and UD in this slate." -ForegroundColor Yellow
    Write-Host "This is normal - platforms often have different prop availability." -ForegroundColor Yellow
    Write-Host "Cannot verify trueProb consistency without matching props." -ForegroundColor Yellow
    Write-Host ""
    Write-Host "RECOMMENDATION:" -ForegroundColor Cyan
    Write-Host "Run optimizer on a slate with known overlapping props to verify merge consistency." -ForegroundColor Cyan
    ...
    Write-Host "=== CONCLUSION ===" -ForegroundColor Green
    Write-Host "trueProb values are consistent across platforms!" -ForegroundColor Green
