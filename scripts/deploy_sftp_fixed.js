#!/usr/bin/env node
/**
 * Fixed SFTP deployment script for static dashboard
 * Uses hardcoded credentials to avoid .env issues
 */
...
async function deploy() {
  ...
  try {
    console.log('=== DEPLOYING STATIC DASHBOARD TO IONOS ===');
    ...
    if (content.includes('data-theme="dark"') && content.includes('formatLegs')) {
      console.log('✅ Static dashboard confirmed');
    } else {
      throw new Error('Static dashboard content not detected');
    }
