/**
 * Phase 19D — Breakeven solver and payout-table invariants (migrated from src/__tests__/breakeven.test.ts).
 */
import {
...
import { getPayoutByHits, getStructure, ALL_STRUCTURES } from "../src/config/parlay_structures";
