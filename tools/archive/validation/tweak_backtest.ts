// Archived from src/validation/tweak_backtest.ts (Phase 17V — offline-only; not in tsc root include).
// Phase 8 tweak validation: shows pre/post ROI impact of each EV tweak.
//
// Usage (from repo root):
//   npx ts-node tools/archive/validation/tweak_backtest.ts
//
...
import { PerfTrackerRow } from "../../../src/perf_tracker_types";
import { juiceAwareLegEv } from "../../../src/ev/juice_adjust";
import { getOppAdjustment } from "../../../src/matchups/opp_adjust";
