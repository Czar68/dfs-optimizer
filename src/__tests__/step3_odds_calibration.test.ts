// Step 3 tests: implied prob, odds buckets, time-decay, report, feature flag.
...
describe("odds calibration report", () => {
  it("computeOddsCalibrationReport on synthetic rows with result+impliedProb returns non-empty when data present", () => {
    const rows: PerfTrackerRow[] = [
      { date: "2026-02-01", leg_id: "a", player: "P", stat: "pts", line: 20, book: "fd", trueProb: 0.52, projectedEV: 0.02, playedEV: 0.02, kelly: 0.1, card_tier: 1, result: 1, overOdds: -110, underOdds: -110, side: "over", impliedProb: 0.5238, oddsBucket: "-115:-105" },
      { date: "2026-02-01", leg_id: "b", player: "P", stat: "pts", line: 20, book: "fd", trueProb: 0.52, projectedEV: 0.02, playedEV: 0.02, kelly: 0.1, card_tier: 1, result: 0, overOdds: -110, underOdds: -110, side: "over", impliedProb: 0.5238, oddsBucket: "-115:-105" },
    ];
  ...
  it("report empty when no result or no impliedProb", () => {
    const rowsNoResult: PerfTrackerRow[] = [
      { date: "2026-02-01", leg_id: "a", player: "P", stat: "pts", line: 20, book: "fd", trueProb: 0.52, projectedEV: 0.02, playedEV: 0.02, kelly: 0.1, card_tier: 1, overOdds: -110, underOdds: -110 },
    ];
